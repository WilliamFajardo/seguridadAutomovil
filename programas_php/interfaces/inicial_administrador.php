...
<body>
  ...
  <div id="content">
    ...
    <p>En esta plataforma podrás gestionar los usuarios, configurar el sistema, generar informes y obtener ayuda en caso necesario.</p>
    
    <h2>Usuarios</h2>
    <p>Aquí puedes gestionar los usuarios registrados en el sistema. Agregar nuevos usuarios, editar información existente y Eliminar usuarios.</p>
    
    <h2>Configuración</h2>
    <p>Personaliza la configuración del sistema según tus necesidades. Puedes ajustar opciones de seguridad, notificaciones y preferencias de visualización.</p>
    
    <h2>Informes</h2>
    <p>Genera informes detallados sobre el uso del sistema, estadísticas de usuarios y otras métricas relevantes para evaluar el rendimiento y tomar decisiones informadas.</p>
    
    <h2>Ayuda</h2>
    <p>Si tienes alguna duda o necesitas asistencia, aquí encontrarás recursos útiles, documentación y contacto con el soporte técnico.</p>
  </div>
